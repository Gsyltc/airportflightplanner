...
/**
    ...
    */
   public GeodeticMeasurement(final double ellipsoidalDistance, final double azimuth, final double reverseAzimuth, final double elevationChange)
   {
    ...
    *           starting point to the ending point
    */
   public GeodeticMeasurement(final GeodeticCurve averageCurve, final double elevationChange)
   {
