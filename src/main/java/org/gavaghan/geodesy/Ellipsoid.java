...
/** Semi major axis (meters). */
    ...
    */
   private Ellipsoid(final double semiMajor, final double semiMinor, final double flattening, final double inverseFlattening)
   {
    ...
    * @return
    */
   static public Ellipsoid fromAAndInverseF(final double semiMajor, final double inverseFlattening)
   {
    ...
    * @return
    */
   static public Ellipsoid fromAAndF(final double semiMajor, final double flattening)
   {
