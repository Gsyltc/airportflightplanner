...
/** Elevation, in meters, above the surface of the ellipsoid. */
    ...
    */
   public GlobalPosition(final double latitude, final double longitude, final double elevation)
   {
    ...
    * @param elevation elevation, in meters, above the reference ellipsoid
    */
   public GlobalPosition(final GlobalCoordinates coords, final double elevation)
   {
    ...
    */
   public int compareTo(final GlobalPosition other)
   {
