...
public class CreationFlightInfosPanel extends AbstractCommonPanel {
    ...
    public void build() {
        ...
        final StartDaysModelAdapter startDaysAdapter = (StartDaysModelAdapter) findAdapter(AdapterNames.STARTDAYS_ADAPTER_NAME);
    ...
    public void createAdapters() {
        ...
        attachAdapter(AdapterNames.STARTDAYS_ADAPTER_NAME);
        attachAdapter(AdapterNames.AIR_CLASS_ADAPTER_NAME);
    }
    ...
    private JComboBox<String> createAircraftClassComboBox(final PresentationModel<FlightInfosReader> flInfosPresenter) {
        final AircraftTypeAdapter adapter = (AircraftTypeAdapter) findAdapter(AdapterNames.AIR_CLASS_ADAPTER_NAME);
