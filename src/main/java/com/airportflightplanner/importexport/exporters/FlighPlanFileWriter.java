...
public class FlighPlanFileWriter implements SlotReceiver {
     ...
     *
     */
    protected final void writeFlightPlans(final FlightPlanReader flightPlan) { // NOPMD by sylva on 31/07/16 15:38
        if (null != flightPlan) {
            ...
            if (null != fileName) {
                ...
                try (Writer fileWriter = new OutputStreamWriter(new FileOutputStream(fileName.toFile()), StandardCharsets.UTF_8)) {
                    ...
                    // STARTCALLSIGN
                    if (null != flightPlan.getCallSign() && !flightPlan.getCallSign().isEmpty()) { // NOPMD by sylva on 31/07/16 15:38
                    ...
                    // STARTDAYS
                    if (!flightPlan.getStartDays().isEmpty()) { // NOPMD by sylva on 31/07/16 15:38
                    ...
                    if (null != flightPlan.getFlightToCompletion()) {
                        ...
                        fileWriter.write(System.lineSeparator());
                        if (flightPlan.getFlightToCompletion()) { // NOPMD by sylva on 31/07/16 15:38
                            fileWriter.write("1");
                        } else {
                            fileWriter.write("0");
                        }
